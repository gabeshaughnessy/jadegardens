...
function create_product_taxonomies() {
    ...
    $labels = array(
        ...
        'add_or_remove_items' => __( 'Add or remove batch' ),
        'choose_from_most_used' => __( 'Choose from the most used batch' ),
        'separate_items_with_commas' => __('Separate batches with commas')
    );
